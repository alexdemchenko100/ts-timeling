const strings = {
  ...
  home_des03start: "Ingen tidssløsing,",
  home_des03middle: "bare ekte forbindelser.",
  how_title: "Hvordan funker det?",
  how_title_dec:
    "Vi endrer spillet ved å sette datoene først. I stedet for å sveipe gjennom en endeløs strøm av profiler, kan du bare opprette, utforske og dra på dater.",
  work_title_01: "Angi et event",
  work_title_02: "Se hvem som liker det",
  work_title_03: "Bli litt bedre kjent",
  work_title_04: "På tide å møtes",
  work_dec_01: "Sett opp en dag, tid og aktivitet for ditt neste event. ",
  work_dec_02: "Se hvem som er interessert og bli litt bedre kjent. ",
  work_dec_03: "Chat for å se om vibbene er gode. ",
  work_dec_04: "Bekreft eventet og gjør deg klar til å møtes.",
  m_work_title_01: "Opprett",
  m_work_dec_01:
    "Angi en dag, tid og aktivitet for ditt neste event. Se hvem som er interessert og test vannet.",
  m_work_title_02: "Utforsk",
  m_work_dec_02:
    "Finn og filtrer event nær deg. Slipp en like for å vise at du er interessert!",
  m_work_title_03: "Bekreft",
  m_work_dec_03:
    "Vis interesse, sjekk hva du liker og lag treff. Det er på tide å møtes!",
};
