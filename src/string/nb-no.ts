const strings = {
  ...
  how_title_dec: "We're changing the game, by putting the dates first. Instead of swiping through an endless stream of profiles, you can just create, explore, and go on dates.",
  ...
  m_work_dec_01: "Set a day, time and activity for your next event. See who is interested and test the waters.",
