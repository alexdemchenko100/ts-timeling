const strings = {
  ...
  time_we_met_content_short:
    "Online dating, the Timeling way: Simply create a date, see who likes it and choose a match. Chat or call to test the waters, confirm and meet up. No more wasting time, no more frustration. Simple as that.",
