            ...
            <li>
              <a href="https://facebook.com/timelingapp">
                <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M14.6539 11.791L15.2094 8.17148H11.7364V5.82266C11.7364 4.83242 12.2215 3.86719 13.777 3.86719H15.3559V0.785547C15.3559 0.785547 13.9231 0.541016 12.5531 0.541016C9.69299 0.541016 7.82346 2.27461 7.82346 5.41289V8.17148H4.64417V11.791H7.82346V20.541H11.7364V11.791H14.6539Z" fill="#1C1C1C"/>
                  </g>
                  <defs>
      ...
      <div className="container">
        <div className="hero-flex">
          <div className="hero-info">
            <h1><FormattedMessage id="home_title" /></h1>
            <ul>
              <li><FormattedMessage id="home_des01start" /> <b><FormattedMessage id="home_des01middle" /></b> <FormattedMessage id="home_des01end" /></li>
              <li><FormattedMessage id="home_des02start" /> <b><FormattedMessage id="home_des02middle" /></b> <FormattedMessage id="home_des02end" /></li>
          ...
          <div className="hero-info-img">
            <img src={langPath === "/nb-no/" ? "assets/nor/main_screenshots_nor.png" : "assets/eng/main_screenshots_eng.png"} alt="" />
          </div>
        </div>
      </div>
    </header>
