    ...
    return (
        ...
        >
            <div className="content">
                ...
                <p>
                    These terms and conditions apply between you (the &ldquo;User&rdquo;) and{" "}
                    {COMPANY_NAME}, a company registered in England, the owner and operator of this
                    Website. All references to Website include the related App. Please read these
                ...
                <p>
                    In these terms and conditions, User means any third party that accesses the
                    Website. You are confirming that you are at least 18 years of age by using this
                    Website.
                </p>
                <ol className="list">
                    <li>
                        All Content included on the Website, is the property of {COMPANY_NAME} or
                        other relevant third parties. In these terms and conditions, Content means
                        any text, graphics, images, audio, video, software, data compilations, page
                        ...
                        the Website you acknowledge that such Content is protected by copyright,
                        trademarks, database rights and other intellectual property rights. Nothing
                        on this site shall be construed as granting any license or right to use any
                        trademark, logo or service mark displayed on the site without the owner's
                        prior written permission
                    </li>
                    <li>
                        You may, for your own personal, non-commercial use only retrieve, display
                        and view the Content on a computer screen or mobile device.
                    </li>
                    <li>
                        You must not otherwise reproduce, modify, copy, distribute or use for
                        commercial purposes any Content without the written permission (not by
                        email) of {COMPANY_NAME}.&nbsp;
                    </li>
                    ...
                    <li>
                        ...
                        threatening or otherwise objectionable or in breach of any applicable law or
                        regulation.
                    </li>
                    <li>
                        making, transmitting or storing electronic copies of Content protected by
                        copyright without the written permission (not by email) of the owner.
                    </li>
                    <li>
                        You must ensure that the details provided by you on registration or at any
                        time are true, accurate, correct and complete in all material aspects.
                    </li>
                    <li>
                    ...
                    <li>
                        We may suspend or cancel your registration with immediate effect so long as
                        we act reasonably or if you breach these terms and conditions.
                    </li>
                    <li>
                        You may cancel your registration at any time by informing us in writing to
                        the registered office of {COMPANY_NAME} from time to time. If you do so, you
                        must immediately stop using the Website. Cancellation or suspension of your
                        registration does not affect any of your statutory rights. You can also
                        unsubscribe from the mailing list at any time.
                    </li>
                    <li>
                        This Website may contain links to other sites. Unless expressly stated,
                        these sites are not under the control of {COMPANY_NAME} or that of our
                        associated entities.
                    </li>
                    <li>
                    ...
                    <li>
                        Any online facilities, tools, services or information that {COMPANY_NAME}{" "}
                        makes available through the Website (the Service) is provided "as is" and on
                        ...
                        &nbsp;
                        {COMPANY_NAME} is under no obligation to update information on the Website.
                    </li>
                    <li>
                        Whilst {COMPANY_NAME} uses reasonable endeavours to ensure that the Website
                        is secure and free of errors, viruses and other malware, we give no warranty
                        or guaranty in that regard and all Users take responsibility for their own
                        security, that of their personal details and their computers.
                    </li>
                    <li>
                        {COMPANY_NAME} accepts no liability for any disruption or non-availability
                        of the Website.
                    </li>
                    <li>
                        {COMPANY_NAME} reserves the right to alter, suspend or discontinue any part
                    ...
                    <li>
                        ...
                        liability for death or personal injury resulting from our negligence; (b)
                        limit or exclude our liability for fraud or fraudulent misrepresentation; or
                        (c) limit or exclude any of our liabilities in any way that is not permitted
                        under applicable law.
                    </li>
                    <li>
                        To the maximum extent permitted by applicable law, we will not be liable to
                        you in respect of any losses arising out of events beyond our reasonable
                        control.
                    </li>
                    <li>
                        To the maximum extent permitted by law, {COMPANY_NAME} accepts no liability
                    ...
                    <li>
                        ...
                        defend and hold harmless {COMPANY_NAME}, our affiliates, and their and our
                        respective officers, directors, agents, and employees from and against any
                        and all complaints, demands, claims, damages, losses, costs, liabilities and
                        expenses, including legal fees due to, arising out of, or relating in any
                        way to your access to or use of the Website or Service, your content, or any
                    ...
                    <li>
                        These terms and conditions together with the Privacy Policy contain the
